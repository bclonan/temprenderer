 ...
 */
//TODO : Create a model for each resource you create
export default {
  sBClaimsByUserId: Model,
   sbSubmitAClaim: Model,
   sbGetClaimById: Model,
   sbGetClaimsForUser: Model,
   sbGetYTDEarningsForUser: Model,
   sbGetYTDEarningsForAccount: Model,
};
